...
`;customElements.define("cn-animationtext",class extends it{constructor(){super(),this.animationText='["Kreativitet", "Problemlösning", "Systemutveckling", "Visualisering"]'}updated(){this.#t()}static properties={animationText:{type:String}};render(){return N`
      <style>
...
`;customElements.define("cn-socialmedia",class extends it{constructor(){super()}render(){return N`
      <style>
        ${xt}
      </style>
...
`;customElements.define("cn-specialbutton",class extends it{static get styles(){return wt}constructor(){super(),this.buttonName="Works",this.radius="border-radius: 5px;",this.background=`${ft}`,this.textColor=`${pt}`}static properties={buttonName:{type:String},background:{type:String},textColor:{type:String},direction:{type:String},radius:{type:String}};render(){return N`
...
`;customElements.define("cn-scroll-down",class extends it{constructor(){super()}render(){return N`
    ...
    `}}),customElements.define("cn-about",class extends it{constructor(){super(),this.Rellax=null}static get styles(){return a`
        ...
        <div class="contact-wraper">
          <!-- 
            ...
            <div class="btn-open-contact">
              <!-- special work btn -->
              <cn-specialbutton buttonName="Works" textColor=${pt}></cn-specialbutton>
      ...
      -->
    `}#e(){const t=this.shadowRoot.getElementById("3d-active");ot.init(t,{max:25,speed:400})}});const kt=a`
...
`;customElements.define("cn-footer",class extends it{static get styles(){return a`
      ${kt}
...
`;customElements.define("cn-services",class extends it{static get styles(){return a`
      ${_t}
...
@media only screen and (max-width: 600px) {
  ...
  `;customElements.define("cn-works",class extends it{static get styles(){return a`
      ${$t}
...
`;class Ct extends it{static styles=a`
    ${St}
    `;constructor(){super()}#s=null;set ic(t){this.#s=t,this.requestUpdate()}updated(){this.#a()}render(){const t=this.#s;if(null!==t)return N`
...
`;customElements.define("cn-gallery",class extends it{constructor(){super()}static get styles(){return a`
    .return-button {
      position: fixed;
      left: 5%;
      bottom: 10%;
...
.section-one::before{
    ...
    width: 50%;
    height: 100%;
    background: linear-gradient(-60deg, rgba(244, 249, 255, 0) 30%, ${r(gt)} 0%);
    z-index: 1;
}
...
`;customElements.define("cn-slidshow",class extends it{static styles=Lt;constructor(){super()}updated(){this.#n()}#s=null;set ic(t){this.#s=t}render(){return N`
      <div class="carousel">
        ${this.#s.map((t=>N`
...
`;customElements.define("cn-slid-text",class extends it{static styles=Mt;constructor(){super()}updated(){this.#n()}#d="";set ic(t){this.#d=t}render(){return N`
  ...
  `;constructor(){super()}#c="home";#h=null;render(){return N`
    ...
    `}#p(){if("home"===this.#c)return this.#g();if("gallery"===this.#c)switch(window.scrollY=0,this.#h){case"Software":const t={pageConfig:this.#i.bind(this),collectionName:"Web & Desktop Applications",title:"Webb & Desktop",description:"Jag har arbetat med olika webb- och desktopsapplikationer tidigare. Här är några exempel på dem.",getImages:()=>[{workType:"Online Booking System",description:"Online Booking System",img:"./sourcefile/web/obs/gallery.png"},{workType:"Flight Booking System",description:"Book flight tickets and manage your bookings",img:"./sourcefile/web/jetstream/gallery.png"},{workType:"Orbitz",description:"Solarsystem Exploraton Desktop App",img:"./sourcefile/web/orbitz/gallery.png"},{workType:"Trafikverket-Spotify",description:"Trafikverket-Spotify Desktop App",img:"./sourcefile/web/skonetrafik_spotify/gallery.png"}]};return N`<cn-gallery .ic=${t}></cn-gallery>`;case"UI/UX":const e={pageConfig:this.#i.bind(this),collectionName:"UI/UX",title:"UI/UX",description:"Jag har arbetat med UI & UX protyping tidigare. Här är några exempel på dem.",getImages:()=>[{workType:"Food Delivery App",description:"Mobile App",img:"./sourcefile/uiux/gallery.png"}]};return N`<cn-gallery .ic=${e}></cn-gallery>`;case"E-sport":const i={from:"Home",getPageNavigator:this.#i.bind(this),imgs:[{src:"./sourcefile/gfx/e-sport/youtube/snl.png",title:"Sunlesskhan - YouTube",description:"Make rocket league videos - Over 2M subscribers"},{src:"./sourcefile/gfx/e-sport/youtube/Deezzyy.png",title:"Deezzyy - YouTube",description:"Play video games"},{src:"./sourcefile/gfx/e-sport/youtube/heart.png",title:"Heart Break Kelby - YouTube",description:"Make vlog videos"},{src:"./sourcefile/gfx/e-sport/youtube/pakdel.png",title:"Pakdel Studio - YouTube",description:"Make gfx tutorial videos"},{src:"./sourcefile/gfx/e-sport/twitter/codspx.png",title:"CodspX gaming - Team",description:"Compete in gaming tournaments"},{src:"./sourcefile/gfx/e-sport/twitter/fibeon.png",title:"Fibeon Esport - Team",description:"Compete in rocket leagues tournaments"},{src:"./sourcefile/gfx/e-sport/twitter/rlraderz.png",title:"Rlraderz - Player",description:"Rocket league player"},{src:"./sourcefile/gfx/e-sport/twitter/victario.png",title:"Victario GFX - Studio",description:"Make gfx for gaming"},{src:"./sourcefile/gfx/e-sport/twitch/revamp.png",title:"Revamp - Twitch",description:"Full twitch design - overlay, panels, emotes"},{src:"./sourcefile/gfx/e-sport/twitch/stream.png",title:"Stream - Twitch",description:"Stream window design"},{src:"./sourcefile/gfx/e-sport/twitch/PANEL.png",title:"Panel - Twitch",description:"Panel design"}]};return N`
          ...
          `}}#i=(t,e)=>{this.#c=t,this.#h=e,window.scrollTo(0,0),this.requestUpdate()};#g(){return N`
    <cn-header .ic=${this.#i.bind(this)}></cn-header>
    <cn-animation></cn-animation>
    <cn-overview
      .ic=${this.#i.bind(this)}
    ></cn-overview>`}}customElements.define("cn-app",Pt)})()})();